...
/// \struct vec
/// \brief A wrapper for sycl::vec to extend store API to work
/// around differences between SYCL-1.2.1 and 2020 multi-ptr.
/// \tparam DataT is the element data type of the vec.
/// \tparam NumElements is the number of elements in the vec.
...
class vec : public cl::sycl::vec<DataT, NumElements> {
 public:
  ...
  /// Expose shadowed store function signatures.
  using base_t::store;
};
